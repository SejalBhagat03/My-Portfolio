...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // --- SMART SPLIT FIX ---
      // This checks if the data from DB is a string (e.g., "React, Node").
      // If yes, it splits it into an Array ["React", "Node"] so the app doesn't crash.
      const formattedProjects = (projectsResponse.data || []).map(project => ({
        ...
        Features: typeof project.Features === 'string' 
          ? project.Features.split(',').map(item => item.trim()) 
          : project.Features || [],
      }));
      ...
      // Store in localStorage with the formatted arrays
