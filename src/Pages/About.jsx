      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            I’m a CSE student with a 9.1 CGPA, passionate about full-stack development, backend engineering, and UI/UX.
As the Technical Club Secretary, I help lead tech events and mentor juniors.
I enjoy building clean, scalable web applications using the MERN stack, Supabase, and modern frontend tools.
Always learning and improving to grow into a skilled software engineer.</p>
             {/* Quote Section */}
      <div 
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1rM_R65xz3coC08eOqCJvSfg3pmSsrDw5/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
